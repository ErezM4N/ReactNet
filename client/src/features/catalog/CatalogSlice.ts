...
//brands=Angular
//brands=     >NOT VALID  ---------------> brands=name    >VALID
...
export const catalogSlice = createSlice({
    ...
    reducers: {
        setProductParams: (state, action) => {
            // Going to 'getAxiosParams'
            state.productsLoaded = false;
            state.productParams = { ...state.productParams, ...action.payload, pageNumber: 1 }; //1 page
        },
        setPageNumber: (state, action) => {
            state.productsLoaded = false;
            state.productParams = { ...state.productParams, ...action.payload }; //regular
        },
